...
$BlazorProjectName = "blazor\BlazorLib"         # The folder name of your Blazor WASM project
...
# Paths
$ScriptDir = '..\..'
$BlazorProjectDir = Join-Path $ScriptDir $BlazorProjectName
$SourceDir = Join-Path $BlazorProjectDir "bin\$Configuration\$Framework\browser-wasm\publish\wwwroot"
$DestDir = Join-Path $ScriptDir "$DesktopProjectName\wwwroot"
